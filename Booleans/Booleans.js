...
// // 3. Declare a variable named age. If age is below 16, print "serve butter
// // milk". Otherwise print "serve beer".
// const age = 16;
// if (age < 16) {
//   console.log('serve butter milk');
// } else {
...
const number2 = 939;
const number3 = 40.9;
number % 2 === 0 ? console.log('30 is even') : console.log('30 is odd');
number2 % 2 === 0 ? console.log('939 is even') : console.log('939 is odd');
number3 % 2 === 0 ? console.log('40.9 is even') : console.log('40.9 is odd');
